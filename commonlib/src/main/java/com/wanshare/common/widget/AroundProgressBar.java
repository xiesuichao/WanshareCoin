...
public class AroundProgressBar extends View implements Runnable{
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        try {
            ...
            radius = (int) ta.getDimension(R.styleable.AroundProgressBar_around_radius, 0);
...
//        flickerLeft = -flikerBitmap.getWidth();
    ...
    private String getProgressText() {
        ...
        if(!isFinish){
            if(!isStop){
                text = getContext().getString(R.string.common_download_progress) + progress+"%";
            } else {
                text = getContext().getString(R.string.common_download_continue);
            }
        } else{
            text = getContext().getString(R.string.common_download_finish);
        }
