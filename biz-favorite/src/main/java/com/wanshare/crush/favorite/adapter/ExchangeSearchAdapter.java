...
public class ExchangeSearchAdapter extends CommonAdapter<String> {

    public ExchangeSearchAdapter(Context context){
        super(context, R.layout.favorite_item_exchange_search,new ArrayList<String>());
    }
    @Override
