...
public class FavoriteMarketAdapter extends CommonAdapter<String> {

    public FavoriteMarketAdapter(Context context){
        super(context, R.layout.favorite_item_market,new ArrayList<String>());
    }
