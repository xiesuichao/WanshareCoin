...
import com.wanshare.crush.favorite.adapter.ExchangeSearchAdapter;
 ...
 */
@Route(path = FavoriteArouterConstant.FAVORITE_EXCHANGE_SEARCH)
public class ExchangeSearchActivity extends BaseActivity {
    ...
    private ExchangeSearchAdapter mExchangeSearchAdapter;
    ...
    protected void initView() {
        ...
        mCustomSearchLayout.setHintText(R.string.favorite_enter_exchange_name);
        ...
        mExchangeSearchAdapter = new ExchangeSearchAdapter(getContext());
        mRecyclerView.setLayoutManager(new LinearLayoutManager(getApplicationContext()));
        mRecyclerView.setAdapter(mExchangeSearchAdapter);
    }
    ...
    protected void initData() {
        ...
        mExchangeSearchAdapter.updateList(list);
    }
}
